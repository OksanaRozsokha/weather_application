...
// in weather_application/test/common/library_wrappers/geolocator_wrapper_test.dart.
...
class MockGeolocatorPlatform extends _i1.Mock
  ...
  _i4.Future<_i2.Position> getCurrentPosition(
      ...
      (super.noSuchMethod(Invocation.method(#getCurrentPosition, [], {#locationSettings: locationSettings}),
              returnValue: _i4.Future<_i2.Position>.value(_FakePosition_0(
                  this,
                  Invocation.method(#getCurrentPosition, [],
                      {#locationSettings: locationSettings}))),
              returnValueForMissingStub: _i4.Future<_i2.Position>.value(
                  _FakePosition_0(this, Invocation.method(#getCurrentPosition, [], {#locationSettings: locationSettings}))))
          as _i4.Future<_i2.Position>);
  @override
  ...
  _i4.Stream<_i2.Position> getPositionStream(
      ...
      (super.noSuchMethod(
          ...
          returnValueForMissingStub:
              _i4.Stream<_i2.Position>.empty()) as _i4.Stream<_i2.Position>);
  @override
  ...
  double distanceBetween(double? startLatitude, double? startLongitude,
      ...
      (super.noSuchMethod(
          ...
          returnValue: 0.0,
          returnValueForMissingStub: 0.0) as double);
  @override
...
class MockPosition extends _i1.Mock implements _i2.Position {
  @override
  double get latitude => (super.noSuchMethod(Invocation.getter(#latitude),
      returnValue: 0.0, returnValueForMissingStub: 0.0) as double);
  @override
  double get longitude => (super.noSuchMethod(Invocation.getter(#longitude),
      returnValue: 0.0, returnValueForMissingStub: 0.0) as double);
  @override
  double get altitude => (super.noSuchMethod(Invocation.getter(#altitude),
      returnValue: 0.0, returnValueForMissingStub: 0.0) as double);
  @override
  double get accuracy => (super.noSuchMethod(Invocation.getter(#accuracy),
      returnValue: 0.0, returnValueForMissingStub: 0.0) as double);
  @override
  double get heading => (super.noSuchMethod(Invocation.getter(#heading),
      returnValue: 0.0, returnValueForMissingStub: 0.0) as double);
  @override
  ...
  double get speedAccuracy =>
      (super.noSuchMethod(Invocation.getter(#speedAccuracy),
          returnValue: 0.0, returnValueForMissingStub: 0.0) as double);
  @override
  bool get isMocked => (super.noSuchMethod(Invocation.getter(#isMocked),
